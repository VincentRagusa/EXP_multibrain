...
std::shared_ptr<ParameterLink<int>> GenomicMultiBrainWorld::modePL =
    Parameters::register_parameter(
        "WORLD_TEST-mode", 0, "0 = bit outputs before adding, 1 = add outputs");
std::shared_ptr<ParameterLink<int>> GenomicMultiBrainWorld::numberOfOutputsPL =
    Parameters::register_parameter("WORLD_TEST-numberOfOutputs", 10,
                                   "number of outputs in this world");
std::shared_ptr<ParameterLink<int>> GenomicMultiBrainWorld::evaluationsPerGenerationPL =
    Parameters::register_parameter("WORLD_TEST-evaluationsPerGeneration", 1,
                                   ...
                                   "brains)");
std::shared_ptr<ParameterLink<std::string>> GenomicMultiBrainWorld::groupNamePL =
    Parameters::register_parameter("WORLD_TEST_NAMES-groupNameSpace",
                                   (std::string) "root::",
                                   "namespace of group to be evaluated");
std::shared_ptr<ParameterLink<std::string>> GenomicMultiBrainWorld::brainNamePL =
    Parameters::register_parameter(
...
void GenomicMultiBrainWorld::evaluateSolo(std::shared_ptr<Organism> org, int analyze,
...
void GenomicMultiBrainWorld::evaluate(std::map<std::string, std::shared_ptr<Group>> &groups,
...
GenomicMultiBrainWorld::requiredGroups() {
  ...
  // requires a root group and a brain (in root namespace) and no additional
  // genome,
